...
{
    public static class RPGHeal
    {
        private static readonly string Command = "RPG heal";
        //private static readonly int CooldownInSeconds = 37;
        private static readonly int CooldownInSeconds = RPGCD.Heal;
